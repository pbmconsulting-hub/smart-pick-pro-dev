...
# ============================================================
# CHECK FOR TOURNAMENT MODE REDIRECT
# ============================================================
# If tournament mode is already active (from a previous page), redirect 
# the user to the tournament lobby instead of showing the home page.
try:
    if st.session_state.get("tournament_mode_enabled", False):
        st.switch_page("pages/tournament/16_🏟️_Tournament_Lobby.py")
except Exception:
    pass  # Fall through to normal home page
